<template>
    <div class="charts">
        <div class="chart">
            ...
            <!-- 此处必须用内连样式规定高度 -->
            <ve-line :data="chartData" :data-zoom="dataZoom" :settings="chartSettings" :toolbox="toolbox" element-loading-text="加载中..."
        ...
        <div class="comment">
            {{title}}
        <div><span style="font-weight: bold;">loss</span>:{{loss}}</div>
        </div>
